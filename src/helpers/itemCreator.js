...
const itemSlots = {
  HEAD: {
    slotNumber: 1,
    slotName: "Helmet",
    imgPath: "/loot/helmet/helmet",
    availableImages: 10,
  },
  SHOULDER: {
    slotNumber: 2,
    slotName: "Pauldron",
    imgPath: "/loot/pauldron/pauldron",
    availableImages: 10,
  },
  CHEST: {
    slotNumber: 3,
    slotName: "Breastplate",
    imgPath: "/loot/breastplate/breastplate",
    availableImages: 10,
  },
  HANDS: {
    slotNumber: 4,
    slotName: "Gauntlets",
    imgPath: "/loot/gauntlets/gauntlets",
    availableImages: 10,
  },
  LEGS: {
    slotNumber: 5,
    slotName: "Legplates",
    imgPath: "/loot/legguards/legguards",
    availableImages: 3,
  },
  FEET: {
    slotNumber: 6,
    slotName: "Sabatons",
    imgPath: "/loot/shoes/shoes",
    availableImages: 5,
  },
  RING: {
    slotNumber: 7,
    slotName: "Ring",
    imgPath: "/loot/ring/ring",
    availableImages: 9,
  },
  TRINKET: {
    slotNumber: 8,
    slotName: "Trinket",
    imgPath: "/loot/trinket/trinket",
    availableImages: 5,
  },
  NECKLACE: {
    slotNumber: 9,
    slotName: "Necklace",
    imgPath: "/loot/necklace/necklace",
    availableImages: 9,
  },
  WEAPON: {
    slotNumber: 10,
    slotName: "Weapon",
    imgPath: "/loot/weapons/weapon",
    availableImages: 10,
  },
};
